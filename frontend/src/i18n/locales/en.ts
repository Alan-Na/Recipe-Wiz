const en = {
  ...
  recipeSearch: {
    ...
    toast: {
      ...
      searchTimeoutDesc: 'The recipe API is taking too long. Please try again.',
      saved: 'Recipe saved',
  ...
  savedRecipesPanel: {
    ...
    deleteFailed: 'Failed to remove recipe',
  },
  addMealModal: {
  ...
  aiMealPlanner: {
    panelTitle: 'AI Meal Planner',
    panelSubtitle: 'Generate a personalized weekly plan from your saved recipes',
    profileSection: 'Your Profile',
    needMoreRecipes: 'Save at least 3 recipes to enable AI planning',
    needMoreRecipesShort: 'Need {{count}} more recipe(s)',
    gender: 'Gender',
    male: 'Male',
    female: 'Female',
    age: 'Age',
    height: 'Height (cm)',
    weight: 'Weight (kg)',
    goal: 'Health Goal / Requirements',
    goalPlaceholder: 'e.g. lose weight, build muscle, eat more protein, low carb...',
    generateButton: 'Generate Meal Plan',
    generating: 'Generating...',
    previewTitle: 'AI-Generated Meal Plan Preview',
    mealsCount: 'meals',
    regenerateButton: 'Regenerate',
    confirmButton: 'Confirm & Save to Calendar',
    confirming: 'Saving...',
    confirmedTitle: 'Meal plan saved to your calendar!',
    confirmedSubtitle: 'Scroll down to view your updated week.',
    resetButton: 'Generate Another Plan',
    toast: {
      generateFailed: 'AI generation failed',
      confirmFailed: 'Failed to save meal plan',
      confirmed: 'AI meal plan saved!',
      tryAgain: 'Please try again later.',
    },
  },
} as const;
